...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			SIMSM_URL.'assets/js/alpha-colorpicker.js',
		...
		wp_enqueue_style(
			'alpha-color-picker',
			SIMSM_URL.'assets/css/alpha-colorpicker.css',
	...
	public function render_content() {
		...
		<label>
			...
			<input class="alpha-color-control" type="text" data-show-opacity="<?php echo esc_attr( $show_opacity ); ?>" data-palette="<?php echo esc_attr( $palette ); ?>" data-default-color="<?php echo esc_attr( $this->settings['default']->default ); ?>" <?php  esc_html( $this->link() ); ?>  />
		</label>
		<?php
	}
}